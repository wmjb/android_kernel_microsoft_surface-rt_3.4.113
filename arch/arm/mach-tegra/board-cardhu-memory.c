...
static const struct tegra30_emc_table cardhu_emc_tables_codezero[] = {
...
static struct tegra30_emc_pdata cardhu_emc_chip_codezero = {
	.description = "ramcode0",
	.tables = (struct tegra30_emc_table *)cardhu_emc_tables_codezero,
	.num_tables = ARRAY_SIZE(cardhu_emc_tables_codezero)
};
...
int __init cardhu_emc_init(void)
{
	...
	emc_platdata = &cardhu_emc_chip_codezero;
